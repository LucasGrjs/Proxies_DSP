/*******************************************************************************************************
 *
 * FIPAMessage.java, in gama.extension.fipa, is part of the source code of the
...
public class FIPAMessage extends GamaMessage {
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.extensions.fipa.IMessage#getMessage()
	 */
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.extensions.fipa.IMessage#getSender()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.extensions.fipa.IMessage#getPerformative()
	 */
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.extensions.fipa.IMessage#setPerformative(int)
	 */
