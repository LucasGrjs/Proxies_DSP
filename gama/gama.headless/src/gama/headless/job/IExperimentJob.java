/*******************************************************************************************************
 *
 * IExperimentJob.java, in gama.headless, is part of the source code of the GAMA modeling and simulation platform
 * .
 *
...
public interface IExperimentJob extends Runnable {
	...
	public class DebugStream extends FileOutputStream {
		...
		DebugStream(final IExperimentJob si) throws FileNotFoundException {
			...
			DEBUG.OUT("OUTPUT_PATH : " + OUTPUT_PATH);
			DEBUG.OUT("CONSOLE_OUTPUT_FILENAME : " + CONSOLE_OUTPUT_FILENAME);
		...
		public DebugStream(int index) throws FileNotFoundException {
			...
			DEBUG.OUT("OUTPUT_PATH2 " + OUTPUT_PATH);
			DEBUG.OUT("CONSOLE_OUTPUT_FILENAME2 " + CONSOLE_OUTPUT_FILENAME);
