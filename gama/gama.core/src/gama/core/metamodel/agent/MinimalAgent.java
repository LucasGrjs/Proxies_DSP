...
public class MinimalAgent extends AbstractAgent {
	...
	/** The orginal Simulation ID **/
	public int originalSimulationID;
	...
	{
		//DEBUG.OUT("custom custom equals minimal : " + this + " :: " + obj);
	...
	@action (
			name = "getUUID",
			doc = @doc ("get uniqueID of current agent"))
	...
	public void setOriginalSimulationID(int originalSimulationID) {
		this.originalSimulationID = originalSimulationID;
		
	}

	@Override
	public int getOriginalSimulationID() {
		return this.originalSimulationID;
	}
}
