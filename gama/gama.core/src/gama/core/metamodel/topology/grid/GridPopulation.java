...
public class GridPopulation implements IPopulation<IGridAgent> {
	...
	@Override
	public IGridAgent getOrCreateAgent(final IScope scope, final Integer index, Map<String, Object> initValues) {
		return getAgent(index);
	}
	
	@Override
	public IGridAgent getOrCreateAgent(final IScope scope, final int index, Map<String, Object> initValues, final UUID uuid) {
		return getAgent(index);
	}
